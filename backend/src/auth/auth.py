...
AUTH0_DOMAIN = 'fsndcoffee-shop.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'drinks'
...
@TODO implement verify_decode_jwt(token) method
    ...
    for-http-en-wikipedia-org
'''


def verify_decode_jwt(token):
    mainurl = f'https://{AUTH0_DOMAIN}/.well-known/jwks.json'
    jsonurl = urllib.request.urlopen(mainurl)
